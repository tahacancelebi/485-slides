...
Dördüncü soru Q4: Sınıfların uyumu ve kalıtım yapısı nasıldır, test edilebilirliği ve yeniden kullanılabilirliği engelleyebilecek uyum problemleri var mı? Bunu LCOM (Lack of Cohesion in Methods), DIT (Depth of Inheritance Tree) ve NOC (Number of Children) metrikleri ile ölçüyoruz.
...
Question four, Q4: What is the cohesion and inheritance structure, and are there cohesion problems that may hinder testability and reusability? We measure this with LCOM (Lack of Cohesion in Methods), DIT (Depth of Inheritance Tree), and NOC (Number of Children).
