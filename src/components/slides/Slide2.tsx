...
export default function WhyBrandsStruggleSlide() {
  // Sadece kumlu/kâğıt dokusu tüm ekranda
  const noiseStyle = {
    backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.8' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)'/%3E%3C/svg%3E")`,
  };

  // Nokta dokusu (Görseldeki gibi noktalar daha seyrek ve belirgin)
  const dotsStyle = {
  ...
  return (
    <div className="w-full min-h-screen relative overflow-hidden font-sans flex text-[#F4EFE2]">
      ...
      {/* --- SOL KOLON (Turuncu Kısım - Tam Ekran Yüksekliği) --- */}
      {/* pb-[16vh] ile sağdaki lacivert kutunun yüksekliği kadar alttan boşluk bırakıyoruz */}
      <div className="w-[55%] bg-[#E65C41] relative flex flex-col p-10 md:p-14 lg:p-16 pb-[16vh] z-10">
        ...
        {/* Ana Dev Başlık (Full width, tek metin, renk ayrımı) */}
        <div className="mt-28 w-full">
          <h1 className="text-[6vw] font-black leading-[0.82] tracking-tighter transform scale-y-[1.1] origin-bottom-left">
            <span className="text-[#EAD037]">Most Companies Fail to</span>{' '}
            Maximize Their Marketing Potential.
          </h1>
        </div>

        {/* SOL ALT: Çizgi ve Açıklama (%16'lık alt çizginin tam üstüne oturur) */}
        {/* absolute kullanarak sağ sütunun kesişim noktasına milimetrik hizalıyoruz */}
      ...
      {/* Sol kolon w-[55%] olduğu için burayı w-[45%] yapıyoruz ki yan yana tam otursunlar */}
      <div className="w-[45%] flex flex-col relative z-10 h-screen">
        ...
        <div className="flex-1 bg-[#323681] relative flex flex-col items-center justify-center p-10 lg:p-14 overflow-hidden">
          {/* 1. Katman: Nokta Dokusu (Sadece arka planda var) */}
          <div
            className="absolute inset-0 pointer-events-none"
            style={dotsStyle}
          />

          {/* 2. Katman: Genel Kumlanma (Noise) Dokusu */}
          <div
          ...
          <div className="relative z-20 w-[70%] max-w-[480px] aspect-square rounded-full bg-[#22245C] flex flex-col items-center justify-center shadow-2xl mt-4">
            {/* Çembere Özel Noise Dokusu (Noktasız, sadece kumlu) */}
            ...
            <p className="absolute bottom-[0%] text-center text-[0.75rem] lg:text-[0.9rem] font-medium max-w-[220px] lg:max-w-[260px] leading-tight text-[#F4EFE2]/90 relative z-10 tracking-wide">
              ...
              <br />
              Due To Poor Targeting And
              <br />
              Content Misalignment.
            </p>

            {/* Yüzde Rozeti (Çemberin dışına tam orantılı taşması için absolute) */}
